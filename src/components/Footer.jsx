...
export default function Footer() {
  return (
    <footer className="bg-[#1d5c5c] text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <a href="/" className="inline-block mb-6">
              <img src="/logo-white.svg" alt="City Dental Care" className="h-auto w-[180px]" />
            </a>
      ...
      <div className="bg-[#0f3333] py-4 text-center text-sm">
